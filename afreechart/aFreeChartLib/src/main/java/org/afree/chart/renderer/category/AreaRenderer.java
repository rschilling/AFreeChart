 ...
 * by the <code>AreaChartDemo1.java</code> program included in the AFreeChart
 * Demo Collection:
 * <br><br>
...
public class AreaRenderer extends AbstractCategoryItemRenderer
    ...
    public void drawItem(Canvas canvas,
        ...
        if (value != null) {
            ...
            paint.setStrokeWidth(getItemStroke(row, column));
            ...
            if (isItemLabelVisible(row, column)) {
                drawItemLabel(canvas, orientation, dataset, row, column, x1, y1,
