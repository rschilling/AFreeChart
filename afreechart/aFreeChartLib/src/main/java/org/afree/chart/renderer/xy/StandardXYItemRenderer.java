...
public class StandardXYItemRenderer extends AbstractXYItemRenderer
     ...
     *
     * @deprecated As of JFreeChart 1.0.8, this override should not be used.
     */
...
//        setURLGenerator(urlGenerator);
     ...
     *
     * @deprecated As of JFreeChart 1.0.8, you should avoid using this method and rely
...
//                }
                ...
                PaintType linePaintType = paintType;
...
//                        this.plotLines, this.legendLine, lineStroke, linePaint);
                result = new LegendItem(label, description, toolTipText,
                        urlText, this.baseShapesVisible, shape, shapeFilled,
                        paintType, !shapeFilled, paintType, lineStroke,
                        this.plotLines, this.legendLine, lineStroke, linePaintType);
    ...
    public void drawItem(Canvas canvas,
        ...
        PaintType paintType = getItemPaintType(series, item);
        //Stroke seriesStroke = getItemStroke(series, item);
        Float seriesStroke = getItemStroke(series, item);
                ...
                if (item == dataset.getItemCount(series) - 1) {
                    if (s.seriesIndex == series) {
                        ...
                        Paint paint = PaintUtility.createPaint(
                                ...
                                lookupSeriesStroke(series),
                                lookupSeriesEffect(series));
                    ...
                    if (drawLine) {
                        ...
                        if (state.workingLine.intersects(dataArea)) {
                            Paint paint = PaintUtility.createPaint(
                                    ...
                                    seriesStroke,
                                    effect);
                            state.workingLine.draw(canvas, paint);
                        }
                    }
                }
            }
...
//                        transY1, image);
//                canvas.drawImage(image, (int) (transX1 - hotspot.getX()),
//                        (int) (transY1 - hotspot.getY()), null);
//                entityArea = new RectShape(transX1 - hotspot.getX(),
