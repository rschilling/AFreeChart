 ...
 * <code>XYBarChartDemo1.java</code> program included in the AFreeChart
 * demo collection:
 * <br><br>
...
public class XYBarRenderer extends AbstractXYItemRenderer
     ...
     * {@link RendererChangeEvent} to all registered listeners.
     *
     * @param factory  the factory (<code>null</code> permitted).
     *
...
//                }
    ...
    public void drawItem(Canvas canvas,
        ...
        if (orientation == PlotOrientation.HORIZONTAL) {
            ...
            bar = new RectShape(left, bottom, translatedWidth,
                    top - bottom);
        }
        ...
        if (getShadowsVisible()) {
            this.barPainter.paintBarShadow(canvas, this, series, item, bar, barBase,
                !this.useYInterval);
        }
     ...
     */
    protected void drawItemLabel(Canvas canvas, XYDataset dataset,
            int series, int item, XYPlot plot, XYItemLabelGenerator generator,
            RectShape bar, boolean negative) {
        ...
        if (isInternalAnchor(position.getItemLabelAnchor())) {
            Shape bounds = TextUtilities.calculateRotatedStringBounds(label,
                    canvas, (float) anchorPoint.getX(), (float) anchorPoint.getY(),
