...
public interface XYDataset extends SeriesDataset, Cloneable {
    ...
    /**
     * Returns the number of items in a series. <br>
     * <br>
     * It is recommended that classes that implement this method should throw an
     * <code>IllegalArgumentException</code> if the <code>series</code> argument
    ...
    /**
     * Returns the x-value for an item within a series. The x-values may or may
     * not be returned in ascending order, that is up to the class implementing
     * the interface.
     * 
     * @param series
     *            the series index (in the range <code>0</code> to
