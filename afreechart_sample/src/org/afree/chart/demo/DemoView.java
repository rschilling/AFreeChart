...
//        }
    ...
    public void paintComponent(Canvas canvas) {
        ...
        if (drawWidth < this.minimumDrawWidth) {
            this.scaleX = (float) (drawWidth / this.minimumDrawWidth);
            drawWidth = this.minimumDrawWidth;
        }
        else if (drawWidth > this.maximumDrawWidth) {
            this.scaleX = (float) (drawWidth / this.maximumDrawWidth);
            drawWidth = this.maximumDrawWidth;
        }

        if (drawHeight < this.minimumDrawHeight) {
            this.scaleY = (float) (drawHeight / this.minimumDrawHeight);
            drawHeight = this.minimumDrawHeight;
        }
        else if (drawHeight > this.maximumDrawHeight) {
            this.scaleY = (float) (drawHeight / this.maximumDrawHeight);
